...
export default function MyPatient({ patientId }) {
    ...
    const { data: PatientDetail, isLoading: isPatientLoading, error: patientError } = useGetPatientByIDQuery(patientId);
    ...
    //                 Please wait, we are fetching your account details.
    //             </p>
